...
UNIcompetitions = ['https://fbref.com/en/comps/21/Primera-Division-Stats',
 'https://fbref.com/en/comps/65/A-League-Men-Stats',
 'https://fbref.com/en/comps/196/A-League-Women-Stats',
 'https://fbref.com/en/comps/56/Austrian-Bundesliga-Stats',
 'https://fbref.com/en/comps/286/Frauenliga-Stats',
 'https://fbref.com/en/comps/37/Belgian-First-Division-A-Stats',
 'https://fbref.com/en/comps/296/Womens-Super-League-Stats',
 'https://fbref.com/en/comps/74/Primera-Division-Stats',
 'https://fbref.com/en/comps/24/Serie-A-Stats',
 'https://fbref.com/en/comps/206/Serie-A1-Stats',
 'https://fbref.com/en/comps/67/Bulgarian-First-League-Stats',
 'https://fbref.com/en/comps/211/Canadian-Premier-League-Stats',
 'https://fbref.com/en/comps/35/Primera-Division-Stats',
 'https://fbref.com/en/comps/62/Chinese-Super-League-Stats',
 'https://fbref.com/en/comps/41/Primera-A-Stats',
 'https://fbref.com/en/comps/63/1-HNL-Stats',
 'https://fbref.com/en/comps/66/Czech-First-League-Stats',
 'https://fbref.com/en/comps/50/Superliga-Stats',
 'https://fbref.com/en/comps/340/Kvindeligaen-Stats',
 'https://fbref.com/en/comps/58/Serie-A-Stats',
 'https://fbref.com/en/comps/9/Premier-League-Stats',
 'https://fbref.com/en/comps/189/Womens-Super-League-Stats',
 'https://fbref.com/en/comps/12/La-Liga-Stats',
 'https://fbref.com/en/comps/230/Liga-F-Stats',
 'https://fbref.com/en/comps/43/Veikkausliiga-Stats',
 'https://fbref.com/en/comps/13/Ligue-1-Stats',
 'https://fbref.com/en/comps/193/Division-1-Feminine-Stats',
 'https://fbref.com/en/comps/20/Bundesliga-Stats',
 'https://fbref.com/en/comps/183/Frauen-Bundesliga-Stats',
 'https://fbref.com/en/comps/27/Super-League-Greece-Stats',
 'https://fbref.com/en/comps/46/NB-I-Stats',
 'https://fbref.com/en/comps/378/I-League-Stats',
 'https://fbref.com/en/comps/82/Indian-Super-League-Stats',
 'https://fbref.com/en/comps/64/Persian-Gulf-Pro-League-Stats',
 'https://fbref.com/en/comps/11/Serie-A-Stats',
 'https://fbref.com/en/comps/208/Serie-A-Stats',
 'https://fbref.com/en/comps/25/J1-League-Stats',
 'https://fbref.com/en/comps/893/WE-League-Stats',
 ...
 'https://fbref.com/en/comps/195/Eredivisie-Vrouwen-Stats',
 'https://fbref.com/en/comps/28/Eliteserien-Stats',
 'https://fbref.com/en/comps/185/Toppserien-Stats',
 'https://fbref.com/en/comps/61/Primera-Division-Stats',
 'https://fbref.com/en/comps/44/Liga-1-Stats',
 'https://fbref.com/en/comps/36/Ekstraklasa-Stats',
 'https://fbref.com/en/comps/32/Primeira-Liga-Stats',
 'https://fbref.com/en/comps/47/Liga-I-Stats',
 'https://fbref.com/en/comps/52/Premier-Division-Stats',
 'https://fbref.com/en/comps/30/Russian-Premier-League-Stats',
 'https://fbref.com/en/comps/40/Scottish-Premiership-Stats',
 'https://fbref.com/en/comps/54/Serbian-SuperLiga-Stats',
 'https://fbref.com/en/comps/57/Swiss-Super-League-Stats',
 'https://fbref.com/en/comps/894/Womens-Super-League-Stats',
 'https://fbref.com/en/comps/29/Allsvenskan-Stats',
 'https://fbref.com/en/comps/187/Damallsvenskan-Stats',
 'https://fbref.com/en/comps/26/Super-Lig-Stats',
 'https://fbref.com/en/comps/39/Ukrainian-Premier-League-Stats',
 'https://fbref.com/en/comps/45/Primera-Division-Stats',
 'https://fbref.com/en/comps/22/Major-League-Soccer-Stats',
 'https://fbref.com/en/comps/182/NWSL-Stats',
 'https://fbref.com/en/comps/105/Liga-FUTVE-Stats',
 'https://fbref.com/en/comps/69/Belgian-First-Division-B-Stats',
 'https://fbref.com/en/comps/38/Serie-B-Stats',
 ...
 'https://fbref.com/en/comps/49/J2-League-Stats',
 'https://fbref.com/en/comps/51/Eerste-Divisie-Stats',
 'https://fbref.com/en/comps/72/Scottish-Championship-Stats',
 'https://fbref.com/en/comps/48/Superettan-Stats',
 'https://fbref.com/en/comps/76/NASL-Stats',
 'https://fbref.com/en/comps/68/USL-D-1-Stats',
 'https://fbref.com/en/comps/79/D2-Pro-League-Stats',
 'https://fbref.com/en/comps/15/League-One-Stats',
 ...
 'https://fbref.com/en/comps/137/USL-League-One-Stats']
...
def allcompetitions():
    ...
    compPg = requests.get('https://fbref.com/en/comps/')

    soup = bs.BeautifulSoup(compPg.text, features="lxml")
...
def tableListing(leagueLink):
    ...
    soup = bs.BeautifulSoup(Data.text,features="lxml")
...
def teamRanker(tablelist,teamLink1,teamLink2):
    ...
    x = [tableRank1,tableRank2,tableNum]
    return x
...
fixtureLinks1 = hrefing(rawFixtures)
#pair team href links according to their exact match fixtures
fixtureLinks1 = pairer(fixtureLinks1)
...
bab = 0
for fixture in fixtureLinks1:
    fixture.append(h2h_links[bab])
    fixture.append(competitionList[bab])
    bab+=1
    
fixtureLinks = []
for fixture in fixtureLinks1:
    if fixture[3] in UNIcompetitions:
        fixtureLinks.append(fixture)
    else:
        pass
...
columns = ['HOME', 'AWAY','COMP','GOAL_PERCENT','WIN_PERCENT','TABLE DIFF','HOME_FORM','AWAY_FORM','HOME_GEN_FORM','H2HOME_NAME','H2H_FORM','HOME_GF','AWAY_GA', 'HOME_GA','AWAY_GF','H2H_GOALS']
...
for fixture in fixtureLinks[num001:]:
    ...
    table_positions = tableListing(fixture[3])
    
    home_Rank = teamRanker(table_positions, fixture[0], fixture [1])[0]
    away_Rank = teamRanker(table_positions, fixture[0], fixture [1])[1]
    table_Slots = teamRanker(table_positions, fixture[0], fixture [1])[2]
    
    tableDiff = (away_Rank - home_Rank)/(table_Slots - 1)* 100
    ...
    records = [homeName, awayName,compName,GOAL_PERCENT,WIN_PERCENT,tableDiff,homeResult,awayResult,homeGenResult,h2hHomeName,h2hResult,home_GF,away_GA, home_GA,away_GF,h2hgoals]
    with open('Match Analysis {x}.csv'.format(x=matchDay), 'a') as file:
        writer = csv.writer(file)
